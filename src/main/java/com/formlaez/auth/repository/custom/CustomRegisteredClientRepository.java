package com.formlaez.auth.repository.custom;
...
public class CustomRegisteredClientRepository implements RegisteredClientRepository {
    ...
    private final JpaOauth2RegisteredClientRepository clientRepository;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public CustomRegisteredClientRepository(JpaOauth2RegisteredClientRepository clientRepository) {
    ...
    private RegisteredClient toObject(JpaOauth2RegisteredClient client) {
    ...
    private JpaOauth2RegisteredClient toEntity(RegisteredClient registeredClient) {
        ...
        var entity = new JpaOauth2RegisteredClient();
